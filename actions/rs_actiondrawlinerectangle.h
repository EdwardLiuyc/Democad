...
//    virtual void updateToolBar();
    ...
    void slotNext(RS_Vector startPoint, double width, double heigth);
    void slotOk();
    //是要说逆向添加是么？那就逆向把
    void prepareRectData(RS_Vector startPoint, double width, double heigth);
...
protected:
     ...
     */
    RS_LineData rectData[4];//新建数据用于构建矩形，防止直接输入和绘图数据影响
    RS_LineData data[4];
    /**
     * 1st corner.
     */
