...
#ifndef RS_ACTIONAUTODRAWLEADLINE_H
#define RS_ACTIONAUTODRAWLEADLINE_H
 ...
 * @author Edward Liu
 */
class RS_ActionAutoDrawLeadLine : public RS_PreviewActionInterface {
        Q_OBJECT
public:
    /**
     * Action States.
...
public:
    RS_ActionAutoDrawLeadLine(RS_EntityContainer& container,
                      RS_GraphicView& graphicView);
    virtual ~RS_ActionAutoDrawLeadLine();
...
private:
	...
	QPoint curMousePoint; //当前鼠标坐标点
	QPoint prevMousePoint;//之前鼠标坐标点 
