...
//        std::cout<<"projection="<<projection<<std::endl;
        ...
        const RS_Vector & center= (projection+point)*0.5;
...
//                                           line0->getQuadratic());
		...
		RS_VectorSolutions centers=RS_Information::getIntersection(line0,line1);
//        DEBUG_HEADER();
...
// 	auto&& t=trans(m);
	boost::numeric::ublas::matrix<double> m = rotationMatrix(angle);
    m_vLinear = prod(trans(m), m_vLinear);
