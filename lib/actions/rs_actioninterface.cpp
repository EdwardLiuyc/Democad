...
RS_Snapper(container, graphicView) {
    ...
    status = 0;
    finished = false;
    graphic = NULL;//container.getGraphic();
    document = container.getDocument();// document pointer will be used for undo / redo
...
void RS_ActionInterface::mousePressEvent(QMouseEvent*) {}
 ...
 void RS_ActionInterface::mouseDoubleClickEvent(QMouseEvent*){}
