...
public:
	...
	enum LeadType {
		LeadLine,
		LeadSide,
		LeadArcLineOblique, //圆弧1
		LeadArcLineVertical, //圆弧2
		LeadUnknown
	};
    ...
    enum ActionType {
        ...
        ActionOptionsDrawing,
                ...
                ActionScriptRun,
				ActionDrawLeadLine,
				ActionAutoDrawLeadLine,
				ActionDrawLeadLineSide,
				ActionDrawLeadArcLineVertical,
				ActionDrawLeadArcLineOblique,

		/*Add GraphM supported function*/
		ActionCalDisOfTp,
		ActionShowPosOfTp,
		ActionFullScreen,
		ActionShowMinDistance,
		ActionShowAngel,
		ActionSetOrigin,
		ActionOriginInitial,
		ActionSizeInitial,
        ...
        ActionLast,
		ActionPartTaper,				// 设置部分锥度值，add by zhou.g.x
		ActionAssignR					// 设置部分锥度值，add by zhou.g.x
    };
